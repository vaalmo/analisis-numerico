...
const Bisection = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:5000/non_linear/bisection', jsonData, { headers: { 'Content-Type': 'application/json' } });
      if (response.data) {
      ...
      <Container maxW='550px' color='black'>
        ...
        >
          ...
          <FormControl isInvalid={errors?.lowint} isRequired>
            ...
            <Input type="number" {...register("lowint")} borderColor="#251605" borderWidth="2px" placeholder='-1' />
            {errors?.lowint ? (
          ...
          <FormControl isInvalid={errors?.highint} isRequired>
            ...
            <Input type="number" {...register("highint")} borderColor="#251605" borderWidth="2px" placeholder='7' />
            {errors?.highint ? (
          ...
          <FormControl isInvalid={errors?.tolerance} isRequired>
            ...
            <Input type="number" {...register("tolerance")} borderColor="#251605" borderWidth="2px" placeholder='10e-5' />
            {errors?.tolerance ? (
